...
class DeepSeekOCRImageProcessor:
    ...
    def _process_gundam(
        ...
        global_size = 640 #cfg["global_size"]  # 1024
        ...
        for lin_idx in kept_indices:
            ...
            arr, meta = self._process_standard(tile_pil, mode="small")
            meta.update(
                {
                    "gundam_part": "tile",
                    "tile_index": None,  # dynamic_preprocess doesn't expose (i,j)
